...
DIRECT_SAMPLING_PROFILES: Tuple[SamplingProfile, ...] = (
    ...
    _profile("multivalent_molecular_bridges", "expensive", 100_000, 10, 1.5,
             "ion, ligand, and all-water spatial screening with sparse bridge hyperedges"),
    _profile("hydration_density_channels", "expensive", 100_000, 10, 1.5,
             "reference-aligned sparse water and ion voxel occupancy plus component detection"),
    _profile("ensemble_pocket_dynamics", "expensive", 100_000, 10, 1.5,
             "reference-aligned grid enclosure screening and sparse recurrent-frequency accumulation"),
    _profile("energetic_network_embeddings", "expensive", 10_000, 10, 2.0,
             "all selected common-protein atom pairs plus residue heat kernels"),
...
RUNTIME_CALIBRATIONS: Tuple[RuntimeCalibration, ...] = (
    ...
    RuntimeCalibration("multivalent_molecular_bridges", 1.9204448, 0.0,
                       "nemo-zinc-finger-1000f-423a-1zn-20260825",
                       "completed_single_fixture_provisional_scaling",
                       "19.204448 CPU seconds for 1,000 frames of the 423-atom NEMO fixture with one Zn mediator and 28 selected solute residues, normalized through the generic 0.01 minimum atom-workload multiplier; solvent-rich and multi-mediator scaling remain unvalidated"),
    RuntimeCalibration("hydration_density_channels", 2.000000, 0.0,
                       "nemo-zinc-finger-1000f-423a-1zn-density-20260825",
                       "completed_single_fixture_provisional_scaling",
                       "19.34 CPU seconds for 1,000 frames of the 423-atom NEMO fixture with one Zn species and one retained density component, rounded conservatively and normalized through the generic 0.01 minimum atom-workload multiplier; solvent-rich scaling remains unvalidated"),
    RuntimeCalibration("ensemble_pocket_dynamics", 4.200000, 0.0,
                       "nemo-zinc-finger-1000f-423a-pocket-grid-20260825",
                       "completed_single_fixture_provisional_scaling",
                       "41.14 CPU seconds for 1,000 frames of the 423-atom NEMO fixture using the shared per-frame geometric grid screen, rounded conservatively and normalized through the generic 0.01 minimum atom-workload multiplier; the native_frequency_grid_v2 aggregation is expected to be cheaper than the calibrated legacy tracking stage, but its larger-system scaling remains unvalidated"),
    RuntimeCalibration("energetic_network_embeddings", 10.000000, 0.0,
                       "cowan-thayer-native-pairwise-proxy-v1", "conservative_proxy",
                       "unbenchmarked all-pairs native NumPy proxy; project-local pilot required"),
...
_CAMPAIGN_PRIORITY = {
    ...
    "multivalent_molecular_bridges": 5.0,
    "hydration_density_channels": 5.0,
    "ensemble_pocket_dynamics": 5.0,
    "energetic_network_embeddings": 5.0,
...
INHERITED_FRAME_SOURCES: Mapping[str, str] = {
    ...
    "interaction_fingerprints": "hydrogen_bond_discovery",
