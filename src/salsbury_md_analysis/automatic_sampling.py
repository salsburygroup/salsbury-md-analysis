...
DIRECT_SAMPLING_PROFILES: Tuple[SamplingProfile, ...] = (
    ...
    _profile("ensemble_pocket_dynamics", "expensive", 100_000, 10, 1.5,
             "reference-aligned grid enclosure screening and bounded pocket tracking"),
...
RUNTIME_CALIBRATIONS: Tuple[RuntimeCalibration, ...] = (
    ...
    RuntimeCalibration("ensemble_pocket_dynamics", 4.200000, 0.0,
                       ...
                       "completed_single_fixture_provisional_scaling",
                       "41.14 CPU seconds for 1,000 frames of the 423-atom NEMO fixture, yielding 9,253 connected bounded frame instances and 32 tracked geometric pocket clusters without per-frame cap truncation, rounded conservatively and normalized through the generic 0.01 minimum atom-workload multiplier; larger-system scaling remains unvalidated"),
