...
_PROFILES.extend([
    ...
    _profile("ensemble_pocket_dynamics", "recurrent_pocket_frequency_map", 100, 500, rationale="recurrent geometric pocket-frequency regions require distributed configurations; the default backend does not infer temporal transitions or track discrete frame-pocket identities"),
