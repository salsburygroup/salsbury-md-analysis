...
- Suppress multivalent-bridge residence summaries for static ensembles while
  retaining occupancy and geometry. Disable experimental methods whose current
  estimators or validation require ordered frames.
